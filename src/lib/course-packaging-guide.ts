/**
 * Packaging guide written into the user's courses folder for humans + AI agents.
 * Filename: COURSE_TEMPLATE.md
 */

export const PACKAGING_GUIDE_FILENAME = "COURSE_TEMPLATE.md";

export const PACKAGING_GUIDE_MARKDOWN = `# CourseDesk — course packaging guide
